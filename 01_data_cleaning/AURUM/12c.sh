...
# --- Configuration ---
TOTAL_TASKS_TO_PROCESS=805 # This means array indices from 0 to 1046
...
SBATCH_TEMPLATE_FILE="/scratch/alice/b/bg205/01_03_AURUM/12b.sbatch" # Assumed to be in the same directory
# --- End Configuration ---
...
echo "Please check your output files and logs in /scratch/alice/b/bg205/01_03_AURUM/drugissue/logs"
